...
export default function AgentsPage() {
  return <main className={styles.page}>
    ...
    <section className={styles.hero}>
      <div className={styles.heroInner}>
        ...
        <div className={styles.heroGrid}>
          <p>Research the market, pressure-test the story, and prepare the move—then bring the findings into a FrontierGTM consulting engagement or adapt the workflow to your company.</p>
    ...
    <section className={styles.operatingModel}>
      <div className={styles.shell}>
        ...
        <div className={styles.steps}>
          ...
          <article><CheckCircle size={28} /><span>02</span><h3>Apply it with FrontierGTM</h3><p>Validate the evidence, sharpen the judgment, and apply the result to the company’s actual constraints.</p></article>
    ...
    <section className={styles.cta}>
      <div className={styles.shell}><div><p>FrontierGTM consulting + agents</p><h2>Use the platform—or bring it into the room.</h2><span>FrontierGTM combines senior GTM judgment with specialized agents that make the research, strategy, and execution more rigorous and repeatable.</span></div><div><a href="mailto:ryan@frontiergtm.ai?subject=FrontierGTM%20consultation">Request a consultation <ArrowRight size={16} /></a><Link href="/agent-builds">Explore custom Agent Builds</Link></div></div>
    </section>
  </main>;
}
